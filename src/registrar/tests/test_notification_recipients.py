...
class TestDomainNotificationRecipients(TestCase):
    ...
    def setUp(self):
        ...
        UserDomainRole.objects.create(
            domain=self.domain, user=self.manager, role=UserDomainRole.Roles.MANAGER
        )
    ...
    def test_renewal_keeps_organization_admin_recipients(self):
        ...
        domain_info.portfolio.portfolio_admin_users.values_list.return_value.distinct.return_value = ["admin@example.org"]
